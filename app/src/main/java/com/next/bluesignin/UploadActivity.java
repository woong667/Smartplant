...
public class UploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static class myDBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE user_plant(USER VARCHAR(128)PRIMARY KEY,PLANTTYPE VARCHAR(128) NOT NULL,PLANTPHOTO VARCHAR(255) NOT NULL,PLANTNAME VARCHAR(128) NOT NULL,DES VARCHAR(255) NOT NULL,TEMPARATURE VARCHAR(128) NOT NULL,HUMID VARCHAR(128) NOT NULL )");
        }
